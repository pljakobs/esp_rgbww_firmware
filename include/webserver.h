...
private:
    ...
    bool checkHeap(HttpResponse &response, uint minHeap);
    bool preflightRequest(HttpRequest& request, HttpResponse& response, std::initializer_list<HttpMethod> allowedMethods, uint minHeap = 0 );
    String makeId();
