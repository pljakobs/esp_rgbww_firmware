 ...
 * 
 * The following layouts are esp8266 only, esp32 uses larger rom partitions due to the
 * compiler creating larger binaries. (esp-idf is inherently larger than esp8266 nonos)
 * 
